...
<div class="menu-wrap">
	<ul class="menu"><li class="menu-slot"><a href="/">Home</a></li><li class="menu-slot"><a href="/subscriptions">Subscriptions</a></li><li class="menu-slot"><a href="' . URL::movies_unifaction_community() . Me::$slg . '">Movies Community</a></li><li class="menu-slot"><a href="' . URL::shows_unifaction_community() . Me::$slg . '">Shows Community</a></li></ul>
</div>');
