...
define("SITE_SALT", "HEbhpQPPyehPRz,3HCdNqr6n.k4~DtZ*,lz3xsrvMo6Fk8,eQtzm-jOcrj8kj8G4MPDg");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "unifaction.community.test";
