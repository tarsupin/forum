...
define("SITE_SALT", "gJO1sJ0Z:+wVpSyz,~D5XfM70ic*-6fnDO|P,2f,8Kf5@KXYyxEaTdpD38WTQ_XE7xV");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://programming.unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "programming.unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://programming.unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "programming.unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://programming.unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "programming.unifaction.community.test";
