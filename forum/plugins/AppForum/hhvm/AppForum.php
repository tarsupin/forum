...
/****** Retrieve a Forum ******/
	...
	(
		int $forumID	// <int> The ID of the forum you're retrieving.
	): array <str, mixed>				// RETURNS <str:mixed> an array of the data for the forum.
...
/****** Get a list of Forum Categories (within the forum specified) ******/
	...
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> an array of categories.
...
/****** Get a list of subforums within a particular forum ******/
	...
	(
		int $parentID		// <int> The ID of the forum you're retrieving subforums from.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> an array of forums.
...
/****** Display a Forum Line by the ID ******/
	...
	(
		array <str, mixed> $forum				// <str:mixed> The data of the forum to display.
