...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::business_unifaction_community() . Me::$slg . '">Business Community<span class="icon-circle-right nav-arrow"></span></a></li>
		...
		<li class="nav-slot"><a href="' . URL::politics_unifaction_community() . Me::$slg . '">Politics Community<span class="icon-circle-right nav-arrow"></span></a></li>
