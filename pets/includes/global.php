...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::food_unifaction_community() . Me::$slg . '">Food Communities<span class="icon-circle-right nav-arrow"></span></a></li>
