...
define("SITE_SALT", "Qay-@aEI=yylw=-C8yr.FRJshvg5W0l|Giz8aH90wsQrN~nm:RN4a.nkd@BGDb8X,d0");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://pets.unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "pets.unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://pets.unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "pets.unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://pets.unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "pets.unifaction.community.test";
