...
define("SITE_SALT", "451.gOJ;Af2q0UvXRENKB+6PwN6kESMBHJIDs|eMc8w:eIeJ+Dr5y0dS.gb@;3Wfc:+t");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://diyhome.unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "diyhome.unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://diyhome.unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "diyhome.unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://diyhome.unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "diyhome.unifaction.community.test";
