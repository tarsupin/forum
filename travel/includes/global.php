...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::fashion_unifaction_community() . Me::$slg . '">Fashion Community<span class="icon-circle-right nav-arrow"></span></a></li>
