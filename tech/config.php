...
define("SITE_SALT", "S-bPrciGu2Jjj!FRophluUP~64@KH:cSqP93Q3aSUcXWtw+eOet!A3l1y=76v,FEP1*3");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://tech.unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "tech.unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://tech.unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "tech.unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://tech.unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "tech.unifaction.community.test";
