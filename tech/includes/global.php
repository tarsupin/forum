...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::gaming_unifaction_community() . Me::$slg . '">Gaming Community<span class="icon-circle-right nav-arrow"></span></a></li>
		...
		<li class="nav-slot"><a href="' . URL::science_unifaction_community() . Me::$slg . '">Science Community<span class="icon-circle-right nav-arrow"></span></a></li>
	</ul>
</div>');