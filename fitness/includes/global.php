...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::food_unifaction_community() . Me::$slg . '">Food Community<span class="icon-circle-right nav-arrow"></span></a></li>
		<li class="nav-slot"><a href="' . URL::movies_unifaction_community() . Me::$slg . '">Movie Fans<span class="icon-circle-right nav-arrow"></span></a></li>
		<li class="nav-slot"><a href="' . URL::unifaction_com() . '/communities' . Me::$slg . '#sports-communities">Sports Communities<span class="icon-circle-right nav-arrow"></span></a></li>
