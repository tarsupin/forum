...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::fitness_unifaction_community() . Me::$slg . '">Game Development<span class="icon-circle-right nav-arrow"></span></a></li>
		<li class="nav-slot"><a href="' . URL::food_unifaction_community() . Me::$slg . '">Gaming Fans<span class="icon-circle-right nav-arrow"></span></a></li>
		<li class="nav-slot"><a href="' . URL::pets_unifaction_community() . Me::$slg . '">Tech Community<span class="icon-circle-right nav-arrow"></span></a></li>
		<li class="nav-slot"><a href="' . URL::movies_unifaction_community() . Me::$slg . '">Web Development<span class="icon-circle-right nav-arrow"></span></a></li>
	</ul>
</div>');