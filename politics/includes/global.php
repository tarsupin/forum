...
<div class="panel-box">
	<ul class="panel-slots">
		...
		<li class="nav-slot"><a href="' . URL::pets_unifaction_community() . Me::$slg . '">Pets Community<span class="icon-circle-right nav-arrow"></span></a></li>
