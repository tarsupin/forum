...
define("SITE_SALT", "WG7,;5p4etbSx_*tJ2xBSt|hn6Ujb1qkr!;aMNrzpb.C:HSApk@UaDUNsg.Kg|VD3~o!");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://shows.unifaction.community");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "shows.unifaction.community";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://shows.unifaction.community.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "shows.unifaction.community.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://shows.unifaction.community.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "shows.unifaction.community.test";
