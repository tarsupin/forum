...
<div class="menu-wrap">
	<ul class="menu"><li class="menu-slot"><a href="/">Home</a></li><li class="menu-slot"><a href="/subscriptions">Subscriptions</a></li><li class="menu-slot"><a href="' . URL::travel_unifaction_community() . Me::$slg . '">Travel Community</a></li><li class="menu-slot"><a href="' . URL::fitness_unifaction_community() . Me::$slg . '">Fitness Community</a></li></ul>
</div>');
